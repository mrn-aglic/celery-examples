...
from workflows.worker.test_tasks import insert_chain, print_task, simple_pipeline, split_group
...
def setup_periodic_tasks(sender, **kwargs):
    try:
        ...
        # insert_chain.pipeline.apply_async(countdown=0)
        split_group.pipeline.apply_async(countdown=0)
